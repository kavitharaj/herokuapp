...
public class TC_APT_014 extends setupClass{
	@Test
	public void verify_Withoutreadmissionclick_Withdateandcomment() {
try {
		...
		if (Confirmappoint.equals("Appointment Confirmation")) {
			System.out.println("Test is passed if  give visit date and sent comment ");

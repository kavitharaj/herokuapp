...
public class TC_APT_012 extends setupClass {
	@Test
	public void verify_readmissionclick_Withoutdate() {
try {
		...
		if (makeappointment.equals("Make Appointment")) {
			System.out.println("Test is passed if dont give visit date and click readmisison ");
